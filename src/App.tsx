...
import { AlertTriangle, Download, Moon, Search, ShieldAlert, Sun, Upload } from 'lucide-react';
...
export default function App() {
  ...
  return <div className={dark?'app dark':'app'}>
    <header><div><span className="eyebrow">AI EVALUATION · RELEASE ENGINEERING</span><h1>Model Quality Release Gate</h1><p>Evaluate. Compare. Detect regressions. Decide whether an AI coding model is ready to ship.</p></div><div className="headerActions"><a className="textBtn" href="https://github.com/h00w/model-quality-release-gate" target="_blank" rel="noreferrer">GitHub</a><a className="textBtn" href="https://huggingface.co/spaces/h0000w/model-quality-release-gate" target="_blank" rel="noreferrer">HF Space</a><button className="iconBtn" onClick={()=>setDark(!dark)} aria-label="Toggle theme">{dark?<Sun/>:<Moon/>}</button></div></header>
    ...
    <main>
      ...
      <section id="docs" className="card docs"><ShieldAlert/><div><h2>Evaluation pipeline</h2><p>Model → Evaluation Dataset → Benchmark → Metrics → Regression Detection → Failure Analysis → Release Gate → <b>SHIP / INVESTIGATE / HOLD</b></p><p>Demo model names and results are fictional. The project demonstrates evaluation methodology and deterministic release engineering, not claims about real models.</p><p><a href="https://huggingface.co/datasets/h0000w/model-quality-release-gate" target="_blank" rel="noreferrer">Evaluation dataset</a> · <a href="https://huggingface.co/h0000w/model-quality-release-gate" target="_blank" rel="noreferrer">Model card</a> · <a href="https://hendarmawan.se/model-quality-release-gate/" target="_blank" rel="noreferrer">Portfolio case study</a></p></div></section>
